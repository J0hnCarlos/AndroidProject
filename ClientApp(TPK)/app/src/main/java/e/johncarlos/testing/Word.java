...
public class Word {
    ...
    private String indonesiaTranslation;
     ...
     */
    /*public Word(String defaultTranslation, String tamilTranslation, int audioResourceId, String category, String indonesiaTranslation) {
        this.defaultTranslation = defaultTranslation;
        this.tamilTranslation = tamilTranslation;
        this.audioResourceId = audioResourceId;
        this.category = category;
        this.indonesiaTranslation = indonesiaTranslation;
    }*/
     ...
     * @param category is the word category
     */
    public Word(String defaultTranslation, String tamilTranslation, int imageResourceId, int audioResourceId, String category, String indonesiaTranslation) {
        this.defaultTranslation = defaultTranslation;
        this.tamilTranslation = tamilTranslation;
    ...
    public String getIndonesiaTranlation() {
        return indonesiaTranslation;
    }
}