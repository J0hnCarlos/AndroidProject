...
import e.johncarlos.test.CircleMenuLayout.OnMenuItemClickListener;
		...
		mCircleMenuLayout.setOnMenuItemClickListener(new OnMenuItemClickListener()
		{
			...
			public void itemClick(View view, int pos)
			{
				...
				switch (check){
                    ...
                    case "C":
                    case "D":
                        Intent asd = new Intent(MainCircleActivity.this, SplashActivity.class);
                        startActivity(asd);
                        break;
					...
					case "G":
					case "H":
                        Intent qwe = new Intent(MainCircleActivity.this, SplashActivity.class);
                        startActivity(qwe);
                        break;
				}
				}
