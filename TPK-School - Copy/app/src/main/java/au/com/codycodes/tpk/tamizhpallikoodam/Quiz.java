...
/**
 * This is to create a Quiz with options within a category
 * It contains the word, image and sound resource, as well as four options and one correct answer
 */
public class Quiz {
    ...
    // Quiz constructor to create Quiz object
