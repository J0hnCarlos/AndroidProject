...
/**
 * This creates the layout for the home page, which has four selections to go to:
 * vocabulary, game, website or about
 */
public class HomeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {

    // A CardView displays the item in a box with a shadow underneath to appear elevated on the screen
    CardView vocabulary;
    CardView game;
    CardView website;
    CardView about;
